...
def run_hermes(job: dict, hermes_cli: str, hermes_home: Path,
    ...
    prompt = (
        ...
        "Tienes disponible el conjunto MCP vikunja-dashboard para consultar, actualizar y crear tareas "
        "y proyectos LT1-LT7/Transversal, además de completar tareas y añadir comentarios. "
        ...
        "usuario lo pidió explícitamente; no crees una línea LT/TR duplicada ni fuera de LT1-LT7/Transversal. "
